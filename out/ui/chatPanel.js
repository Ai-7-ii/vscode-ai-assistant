...
class ChatPanel {
    constructor(panel, extensionUri, deepSeekClient) {
        this.disposables = [];
        this.messageHistory = [];
        this.panel = panel;
    ...
    static createOrShow(extensionUri, deepSeekClient) {
        ...
        const panel = vscode.window.createWebviewPanel('intelliflowChat', 'IntelliFlow AI Assistant', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    getWebviewContent() {
        const styleUri = this.panel.webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, 'src', 'ui', 'styles.css'));
        const scriptUri = this.panel.webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, 'src', 'ui', 'webview.js'));
        return `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
